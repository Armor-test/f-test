describe('hx-headers attribute', function() {
  ...
  it('basic hx-headers works', function() {
    ...
    const div = make("<div hx-post='/vars' hx-headers='\"i1\":\"test\"'></div>")
    div.click()
    this.server.respond()
  ...
  it('multiple hx-headers works', function() {
    ...
    const div = make("<div hx-post='/vars' hx-headers='\"v1\":\"test\", \"v2\":42'></div>")
    div.click()
    this.server.respond()
    div.innerHTML.should.equal('Clicked!')
  })
  ...
  it('hx-headers overrides inputs', function() {
    ...
    const div = make("<div hx-target='this'><input hx-post='/include' hx-headers='\"i1\":\"best\"' hx-trigger='click' id='i1' name='i1' value='test'/></div>")
    const input = byId('i1')
    input.click()
    this.server.respond()
    div.innerHTML.should.equal('Clicked!')
  ...
  it('basic hx-headers javascript: works', function() {
    ...
    const div = make('<div hx-post="/vars" hx-headers="javascript:i1:\'test\'"></div>')
    div.click()
    this.server.respond()
    div.innerHTML.should.equal('Clicked!')
  })
  ...
  it('multiple hx-headers works', function() {
    ...
    const div = make('<div hx-post="/vars" hx-headers="javascript:v1:\'test\', v2:42"></div>')
    div.click()
    this.server.respond()
    div.innerHTML.should.equal('Clicked!')
  })
  ...
  it('hx-headers overrides inputs', function() {
    ...
    const div = make('<div hx-target="this"><input hx-post="/include" hx-headers="javascript:i1:\'best\'" hx-trigger="click" id="i1" name="i1" value="test"/></div>')
    const input = byId('i1')
    input.click()
    this.server.respond()
    div.innerHTML.should.equal('Clicked!')
